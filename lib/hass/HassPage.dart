...
class HassPage extends StatefulWidget {
  @override
  HassPageState createState() => HassPageState();
}

class HassPageState extends State<HassPage> {
  List<HomeSeerArea> data = new List();

  String errorMessage;

  Future _loadData() async {
    this.errorMessage = "Hass sin configurar.";
    setState(() {});
    return;
  }
